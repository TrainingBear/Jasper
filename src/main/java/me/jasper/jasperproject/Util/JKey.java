...
public final class JKey {
    ...
    public static final NamespacedKey BAZAAR_CUSTOM_AMOUNT = new NamespacedKey(JasperProject.getPlugin(), "product_Amount");
    ...
    public static final NamespacedKey ENCHANT_BASEMODIFIER = new NamespacedKey(JasperProject.getPlugin(), "Enchant-basemodifier");
    public static final NamespacedKey ENCHANT_PRESTIGEDMODIFIER = new NamespacedKey(JasperProject.getPlugin(), "Enchant-prestigedmodifier");
    public static final NamespacedKey ENCHANT_PRESTIGELEVEL = new NamespacedKey(JasperProject.getPlugin(), "Enchant-prestigelevel");
